...
<nav class="navbar fixed-top navbar-expand-lg bg-body-tertiary">
	<div class="container-fluid">
		<a class="navbar-brand" href="https://browse.wf/" <?php if ($_SERVER["REQUEST_URI"] == "/"): ?> onclick="event.preventDefault();" <?php endif; ?>>Warframe profile viewer based on browse.wf</a>
		...
		<div class="collapse navbar-collapse" id="navbar-content">
			<div class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<a class="nav-link<?=(substr($_SERVER["REQUEST_URI"], 0, 10) == "/glyphs" ? " active" : ""); ?>" href="/glyphs<?=$ext;?>">Glyphs</a>
				...
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle<?=((substr($_SERVER["REQUEST_URI"], 0, 8) == "/profile" || substr($_SERVER["REQUEST_URI"], 0, 12) == "/prime-vault" || substr($_SERVER["REQUEST_URI"], 0, 11) == "/text-icons" || substr($_SERVER["REQUEST_URI"], 0, 16) == "/platform-suffix" || substr($_SERVER["REQUEST_URI"], 0, 14) == "/invigorations") ? " active" : ""); ?>" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">More Tools</a>
					<ul class="dropdown-menu">
						<li><a class="dropdown-item<?=(substr($_SERVER["REQUEST_URI"], 0, 8) == "/profile" ? " active" : ""); ?>" href="/profile<?=$ext;?>">Profile Viewer</a></li>
